  ...
  <div className='max-w-6xl mx-auto '>
        <div className=" w-full px-4 text-white flex flex-col">
            <div className="w-full text-7xl font-bold">
                <h1 className="w-full md:w-2/3 pt-20">How can we help you. Find
                    a menu</h1>
            </div>
            <div className="flex mt-8 flex-col md:flex-row md:justify-between">
                <p className="w-full md:w-2/3 text-gray-400">Nestled in the heart of the city, LeFaim offers a harmonious blend of culinary delights and invigorating spirits. Drawing inspiration from classic elegance and modern flavors, our restaurant prides itself on crafting unforgettable experiences for every patron.</p>
            ...
            <div className="flex flex-col">
                <div className="flex mt-24 mb-12 flex-row justify-between">
                  ...
                  <Image src={Logo} alt="Logo" />
                    ...
                    <div className="flex flex-row space-x-8 items-center justify-between"><span>{""}</span><span>{""}</span><span>{""}</span>
