  ...
  return (
    <>
      <div className="pt-28 sm:pt-20 flex flex-col w-full lg:flex-row mb-4">
        ...
        <div className="max-w-6xl mx-auto lg:px-0 sm:px-0 sm:py-8">
          ...
          <div className="font-medium leading-7 space-y-2 sm:grid sm:grid-cols-2 lg:grid-cols-2 sm:gap-4 sm:space-y-0">
            {/* <!-- Grid cell #1 --> */}
            <div className="py-3 pt-20 sm:pt-5 p-0 float-left rounded">
              <img
            ...
            {/* <!-- Grid cell #2 --> */}
            <div className=" py-3 px-0 md-lg:ml-0 xl:ml-0 md-lg:mt-10 xl:mt-10 rounded">
