  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative fontordre w-full max-w-xs sm:max-w-md sm:w-96 mx-auto mt-12 ">
          <img
            src="https://media.discordapp.net/attachments/1068131427910168670/1144387451993997322/vector-crumbled-paper-texture.png?width=724&height=1038"
          ...
          <div className="p-6">
            <div className="pb-10 border-b border-black text-center ">
              ...
              <h2 className="text-sm text-gray-600 font-light">
                Customer e-mail:{" "}
                <span className="block">{savedData.email}</span>
              </h2>
            </div>
            <div className="mt-6">
